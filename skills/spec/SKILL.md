...
**Dogfooding:** This skill uses TENET's own multi-agent infrastructure. No external API keys needed. Parallel Task agents debate using the same Claude that powers everything else.
